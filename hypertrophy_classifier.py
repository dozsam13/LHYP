...
class HypertrophyClassifier(nn.Module):
    def __init__(self, c1c2, c2c3, c3c4, c4c5, c5c6, c6l1):
        ...
        self.linear1 = nn.Linear(c6l1 * 9, 3)
        # self.linear2 = nn.Linear(l1l2, 3)
        ...
        # self.linear1_bn = nn.BatchNorm1d(l1l2)
